 ...
 * @dev This implements Chainling VRF v2 and chainlink keeper
 *
 */
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
  ...
  function enterRaffle() public payable {
    ...
    // Named events with the function name revre
    emit RaffleEnter(msg.sender);
  }

  /****
   * @dev This is the function that the chainlink keeper nodes call
   * they look for the `upKeepNeeded` to return trudfsa        iopasdfghjkl;'
   * zasxcvbnm,.. .
   * The following should be true in order to return true.
   *
   * 1. Our timeinterval shoul have passed
  ...
  function fulfillRandomWords(
    ...
    uint256 indexOfWimmer = randomWords[0] % s_players.length;
    address payable recentWinner = s_players[indexOfWimmer];
